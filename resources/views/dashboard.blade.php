...
<body class="bg-gray-200">
  ...
  <main class="  sm:p-10 space-y-4">
    <div class="flex flex-col space-y-4 md:space-y-0 md:flex-row justify-between">
      <div class="mr-6">
        <h1 class="text-5xl text-gray-900 font-semibold mb-1.5">Sujit Bhattarai</h1>
    ...
    <section class="grid md:grid-cols-2 xl:grid-cols-4 xl:grid-rows-3 xl:grid-flow-col gap-2">
      ...
      <div class="flex items-center p-7 bg-white shadow rounded-lg">
        <div
      ...
      <div class="row-span-3 bg-white shadow rounded-lg">
        ...
        <ul class="p-6 space-y-6">
          <li class="flex items-center border-2 border-transparent rounded shadow p-1 hover:border-indigo-300  hover:cursor-pointer">Add tasks here dynamically</li>
          <li class="flex items-center border-2 border-transparent rounded shadow p-1 hover:border-indigo-300  hover:cursor-pointer">Add tasks here dynamically</li>
          <li class="flex items-center border-2 border-transparent rounded shadow p-1 hover:border-indigo-300  hover:cursor-pointer">Add tasks here dynamically</li>
          <li class="flex items-center border-2 border-transparent rounded shadow p-1 hover:border-indigo-300  hover:cursor-pointer">Add tasks here dynamically</li>
        </ul>
      ...
      <div class="flex flex-col row-span-3 bg-white shadow rounded-lg">
        ...
        <div class="p-4 flex-grow">
          <div
            class="flex items-center justify-center h-full px-4 py-24 text-gray-200 text-2xl font-semibold bg-gray-800 border-2 border-gray-200 border-dashed rounded-md">
