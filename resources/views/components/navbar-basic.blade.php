<header class="text-gray-700 body-font border-b border-gray-200">
    <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <nav class="md:ml-auto flex flex-wrap items-center text-base justify-center p-1">
            ...
            <a href="#about" class="mr-5 p-1 hover:text-gray-900 hover:underline hover:decoration-gray-900">About</a>
            <a href="#team" class="mr-5 p-1 hover:text-gray-900 hover:underline hover:decoration-gray-900">Team</a>
            <a href="#contact" class="mr-5 p-1 hover:text-gray-900 hover:underline hover:decoration-gray-900">Contact</a>
        </nav>
    </div>
</header>